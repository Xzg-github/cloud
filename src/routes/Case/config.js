...
const case3 = [
  ...
  {
    title: '云恋基于INFOR WMS系统为某某达提供个性化解决方案',
    list: [
      {
        title: '1.个性化接口承接某某达B2BSCM系统，打通上下游系统数据流',
        description: '云恋定制化系统接口对接某某达的B2BSCM系统，实现采购管理/销售管理与仓库无缝衔接，提升管理效率。'
      },
      {
...
const case4 = [
    ...
    list: [
      {
        ...
        ul: [
          ...
          '仓库作业管理要求：基于SKU操作，以特定批次属性信息分区管理、入库收集批次属性信息、出库指定批次属性出库、' +
           '需支持不同批次属性信息转换；某某达无仓储管理团队、无仓储管理流程、无专业仓储管理人员；'
        ]
      },
      {
        h2: '业务痛点',
  ...
  },
  {
    ...
    list: [
      {
        h2: '入库流程：',
        div: '电商ERP/OMS推送ASN收货单--供应商预约--供应商到货--RF扫描入库--ASN收货单核实并结算--库存回写电商ERP/OMS系统；',
        ul: [
          '电商ERP/OMS系统推送ASN收货单至INFOR WMS系统；',
          'RF扫描入库（扫描二维码，收集目的地市场、PR单号等产地信息）、RF扫描库位、数量入库；',
          '确认并核实ASN收货单，回传入库信息至电商的ERP/OMS系统；'
        ],
      },
      {
        h2: '出库流程：',
        div: '电商ERP/OMS推送出库订单--库存分配--打印拣货单--订单出库--出库明细回写电商ERP/OMS系统；',
        ul: [
          '电商ERP/OMS系统推送出库订单至INFOR WMS系统，出库明细指定批次信息；',
      ...
      {
        h2: '锁库单流程：',
        div: '电商ERP/OMS推送锁库单--INFOR接收并自动锁库--仓库拣货--电商ERP/OMS锁库单取消/库存释放' +
        '--电商ERP/OMS推送出库单--指定批次/库位分配拣货--出库;',
        ul: [
...
const case5 = [
  {
    title: '某格物流仓储管理需求-库存管理需求',
    list: [
      '某格作为供应链公司，提供各式仓储服务，业务管理要求以及操作流程差异大；',
      '某格服务的客户众多、产品以及需求差异化大；',
      '某格在全国各地十几个仓库，需要集中化、标准化管理；'
    ],
    render: renderCase5Demand
  },
  {
    title: '某格物流仓储管理需求-仓库管理流程规划设计应用',
    list: [
      {
        h2: '入库流程：',
  ...
  items: [
    {
      url: '/case1',
      logo: imageUrl('logo1'),
      title: '综合物流行业-某某国际港务集团有限公司',
      business: '综合物流管理',
      product: 'ePLD',
      description: '某某国际港务集团有限公司是大型国有独资企业， 业务涵盖多个海港，' +
      '包括航运管理、铁路及公路多式联运、仓储等综合物流服务。',
      content: case1
    },
    {
      url: '/case2',
      logo: imageUrl('logo2'),
      title: '大型零售商行业-某某玛连锁企业',
      business: '大型零售商',
      product: 'ePLD',
      description: '某某玛是一家美国的世界性连锁企业，以营业额计算为全球最大的公司；公司的业务之所以能够迅速增长，' +
      '并且成为知名公司之一，是因为该公司在节省成本以及在物流配送系统与供应链管理方面取得了巨大的成就。',
      content: case2
    },
    {
      url: '/case3',
      ...
      business: '食品行业',
      product: 'infor WMS',
      description: '某某达国际食品专注进口品牌食品行业，为国内全渠道经销商。',
      content: case3
    },
    {
      url: '/case4',
      ...
      business: '第三方物流',
      product: 'infor WMS',
      description: '某某达集团为深圳民营第三方物流企业，提供的服务范围包含海运、陆运、空运报关、仓储等一条龙服务。' +
      '其主要仓储客户为一些大型电商，专业从事智能移动周边产品、智能生活周边产品及计算机周边产品的研发和销售。',
      description2: '某大型电商仓库原仓储管理以手工Excel台账、物料卡等手段进行仓库管理。' +
      '某大型电商于2017年3月将仓储业务外部至某某达集团公司。云恋科技承接某某达集团IT系统建设，' +
      '协助它从零开始搭建仓储服务，实现仓储管理的信息化、流程标准化以及仓储团队组建等。' +
      '现仓储管理超过10000㎡仓库、43000个SKU、450万PCS的库存管理。',
      content: case4
    },
    {
      url: '/case5',
